 ...
 */
@FacesConverter(value = "religionConverter", forClass = Religion.class)
public class religionConverter implements Converter{
    ...
    public Object getAsObject(FacesContext context, UIComponent arg1, String arg2) throws ConverterException {
        if (arg2.trim().equals("")) {
            ...
            return new Religion(Integer.parseInt(arg2));
        }
    }
    ...
    public String getAsString(FacesContext context, UIComponent arg1, Object arg2) throws ConverterException {
        if (arg2 == null || arg2.equals("")) {
            ...
            return String.valueOf(((Religion) arg2).getReligionid());
        }
    }
}
