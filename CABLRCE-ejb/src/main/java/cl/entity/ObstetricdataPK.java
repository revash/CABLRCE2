 ...
 */
@Embeddable
public class ObstetricdataPK implements Serializable {
    ...
    public ObstetricdataPK() {
    }

    public ObstetricdataPK(int personrut, String persondv, int personnationality, int recordnumber) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ObstetricdataPK)) {
            return false;
        }
        ObstetricdataPK other = (ObstetricdataPK) object;
    ...
    public String toString() {
        return "cl.entity.ObstetricdataPK[ personrut=" + personrut + ", persondv=" + persondv + ", personnationality=" + personnationality + ", recordnumber=" + recordnumber + " ]";
    }
