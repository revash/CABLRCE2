 ...
 */
@Embeddable
public class DiabeticcontrolPK implements Serializable {
    ...
    public DiabeticcontrolPK() {
    }

    public DiabeticcontrolPK(int diabcontrolid, int episodeid, int rut, String dv, int recordnumber, int nationalityid) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DiabeticcontrolPK)) {
            return false;
        }
        DiabeticcontrolPK other = (DiabeticcontrolPK) object;
    ...
    public String toString() {
        return "cl.entity.DiabeticcontrolPK[ diabcontrolid=" + diabcontrolid + ", episodeid=" + episodeid + ", rut=" + rut + ", dv=" + dv + ", recordnumber=" + recordnumber + ", nationalityid=" + nationalityid + " ]";
    }
